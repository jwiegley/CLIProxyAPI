...
// OriginalEndpointRequestMetadataKey stores a route request before compatibility conversion.
const OriginalEndpointRequestMetadataKey = "original_endpoint_request"
